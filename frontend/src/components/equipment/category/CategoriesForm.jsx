...
/**
 * Component for rendering a form to create or update categories.
 * @param {Object} props - The component props.
 * @param {Object} props.category - The category object to be updated (optional).
 ...
 */
const CategoriesForm = ({ category, onClose, setErrorMessage }) => {
