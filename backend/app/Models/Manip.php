 ...
 * Class Manip
 *
 * This class represents a manipulation model in the application. It defines the structure and relationships
 * for managing manipulations in the database.
 *
 * @author Jean-Pierre Faucon
 * @version 1.0
 */
class Manip extends Model
{
    use HasFactory;
